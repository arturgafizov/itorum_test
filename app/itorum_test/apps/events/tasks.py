...
@app.task(name='apps.events.tasks.send_booking_cancellation_confirmation', queue='high_priority')
...
@app.task(name='apps.events.tasks.send_booking_confirmation', queue='high_priority')
...
@app.task(name='apps.events.tasks.send_soon_start_event', queue='high_priority')
...
@app.task(name='apps.events.tasks.cron_task_send_notice_before_event', queue='high_priority')
...
@app.task(name='apps.events.tasks.cron_task_check_event_status', queue='low_priority')
